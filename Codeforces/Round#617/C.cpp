...
int main(){
	...
	tin{
		...
		if(!f){
			rep(i,0,n-3){
				if(s[i]=='R' && s[i+1]=='U' && s[i+2]=='L' && s[i+3]=='D'){
					cout<<i+1<<" "<<i+4<<endl;
					ff=1;
					break;
				}
				if(s[i]=='R' && s[i+1]=='D' && s[i+2]=='L' && s[i+3]=='U'){
					cout<<i+1<<" "<<i+4<<endl;
					ff=1;
					break;
				}
				if(s[i]=='L' && s[i+1]=='U' && s[i+2]=='R' && s[i+3]=='D'){
					cout<<i+1<<" "<<i+4<<endl;
					ff=1;
					break;
				}
				if(s[i]=='L' && s[i+1]=='D' && s[i+2]=='R' && s[i+3]=='U'){
					cout<<i+1<<" "<<i+4<<endl;
					ff=1;
					break;
				}
				if(s[i]=='D' && s[i+1]=='L' && s[i+2]=='U' && s[i+3]=='R'){
					cout<<i+1<<" "<<i+4<<endl;
					ff=1;
					break;
				}
				if(s[i]=='D' && s[i+1]=='R' && s[i+2]=='U' && s[i+3]=='L'){
					cout<<i+1<<" "<<i+4<<endl;
					ff=1;
					break;
				}
				if(s[i]=='U' && s[i+1]=='L' && s[i+2]=='D' && s[i+3]=='R'){
					cout<<i+1<<" "<<i+4<<endl;
					ff=1;
					break;
				}
				if(s[i]=='U' && s[i+1]=='R' && s[i+2]=='D' && s[i+3]=='L'){
					cout<<i+1<<" "<<i+4<<endl;
					ff=1;
					break;
				}
