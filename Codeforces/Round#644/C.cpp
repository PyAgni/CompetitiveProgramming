...
int main(){
	...
	tin{
		...
		// if(o.size()&1 && e.size()%2==0){
		// 	cout<<"NO\n";
		// 	continue;
		// }

		// if(e.size()&1 && o.size()%2==0){
		// 	cout<<"NO\n";
		// 	continue;
		// }
		...
		// 		if(abs(e[i]-o[j]) == 1){
		// 			ctr++;
		// 			e.erase(e.begin(),e.end()+i);
		// 			o.erase(o.begin(),o.end()+j);
		// 		}
		// 	}
		// }
		...
		if(o.size()<=e.size()){
			rep(i,0,o.size()){
					if(find(e.begin(),e.end(),o[i]+1)!=e.end()){
						f=1;
						break;
					}
					if(find(e.begin(),e.end(),o[i]-1)!=e.end()){
		...
		rep(i,0,e.size()){
			if(find(o.begin(),o.end(),e[i]+1)!=o.end()){
				f=1;
				break;
			}
			if(find(o.begin(),o.end(),e[i]-1)!=o.end()){
